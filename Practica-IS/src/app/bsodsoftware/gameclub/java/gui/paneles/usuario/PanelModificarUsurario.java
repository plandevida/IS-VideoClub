...
public class PanelModificarUsurario extends JPanel {
	...
	private void init() {
		...
		btnModificar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					usuario = new Usuario(tDNI.getText(), 
											tNombre.getText(),
											tApellidos.getText(),
											!"".equals(tFNacimiento.getText()) ? new SimpleDateFormat("dd-MM-YYY").parse(tFNacimiento.getText()) : null,
											tDireccion.getText(),
	...
	private void bindUsuario(Usuario usuario) {
		try {
			...
			String fSancion = usuario.getHasta() != null ? new SimpleDateFormat("dd-MM-YYYY").format(usuario.getHasta()) : "";
			
			tFSancion.setText(fSancion);
			tFSancion.setEditable( !tFSancion.isEditable());
			
			String fNacimiento = usuario.getFecha_nacimiento() != null ? new SimpleDateFormat("dd-MM-YYYY").format(usuario.getFecha_nacimiento()) : "";
