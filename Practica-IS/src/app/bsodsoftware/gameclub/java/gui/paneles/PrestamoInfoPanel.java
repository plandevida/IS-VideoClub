...
public class PrestamoInfoPanel extends JPanel {
	...
	public PrestamoInfoPanel(Sistema sistema, VentanaPrincipal ventana) {
							...
							if ( !"".equals(tDNI.getText()) ) {
								...
								if ( usuario != null ) {
									...
									if ( !miSistema.addPrestamo(prestamo) ) {
											JOptionPane.showMessageDialog(miVentana, "Error al crear un prestamo.", "Error", JOptionPane.ERROR_MESSAGE);
									} else {
										JOptionPane.showMessageDialog(miVentana, "Prestamo realizado correctamente."+"\nEl prestamo expira: "+calendario.get(Calendar.DAY_OF_MONTH)+"/"+calendario.get(Calendar.MONTH)+"/"+calendario.get(Calendar.YEAR)//Solucion temporal
												, "Aviso", JOptionPane.INFORMATION_MESSAGE);
									}
								} else {
									JOptionPane.showMessageDialog(miVentana, "El usuario no existe.", "Error", JOptionPane.ERROR_MESSAGE);
								}
							} else {
								JOptionPane.showMessageDialog(miVentana, "Es necesario introducir el DNI (con letra y sin espacios).", "Aviso", JOptionPane.WARNING_MESSAGE);
							}
					} else {
						JOptionPane.showMessageDialog(miVentana, "Debe seleccionar un juego.", "Aviso", JOptionPane.WARNING_MESSAGE);
					}
				}
			});
