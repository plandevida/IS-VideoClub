...
public class PrestamosPanel extends JPanel {
	...
	public PrestamosPanel() {
		...
		Juego juego = new Juego(1, "Colonos del catán", 8,
				"Juego de estrategia", 5, Imagenes.getAdministracion56x56());
		Juego juego1 = new Juego(2, "a", 2, "nada", 5,
				Imagenes.getPrestamos56x56());
		Juego juego2 = new Juego(3, "d", 2, "nada", 5,
